    ...
    <section className="space-y-6">
      <header className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-2">
          <div className="h-7 w-40 animate-pulse rounded-lg bg-zinc-200 dark:bg-white/10" />
          <div className="h-4 w-56 animate-pulse rounded bg-zinc-200 dark:bg-white/10" />
        </div>
      </header>
            ...
            {[0, 1].map((i) => (
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  ...
                  <div className="h-5 w-16 animate-pulse rounded-full bg-zinc-200 dark:bg-white/10" />
                </div>
                <div className="h-3 w-full animate-pulse rounded bg-zinc-100 dark:bg-white/5" />
                <div className="h-3 w-24 animate-pulse rounded bg-zinc-100 dark:bg-white/5" />
              </div>
            ))}
          </div>
        </div>
