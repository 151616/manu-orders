...
export function OrderAttachmentUploadForm({
  ...
  return (
    <form
      ...
      className="space-y-2 rounded-lg border border-zinc-200 bg-zinc-50/80 p-3 dark:border-white/10 dark:bg-white/5"
    >
      <label className="block space-y-1">
        ...
        <input
          ...
          name="attachment"
          required
          className="w-full rounded-md border border-zinc-300/80 bg-white px-3 py-2 text-sm text-black dark:border-white/20 dark:bg-white/5 dark:text-white"
        />
      </label>
