...
function SkeletonSection({ rows = 2 }: { rows?: number }) {
  return (
    <div className="animate-pulse space-y-4 rounded-xl border border-zinc-200 bg-white/95 p-4 shadow-sm sm:p-6 dark:border-white/10 dark:bg-white/5">
...
export default function OrderDetailLoading() {
  return (
    <div className="space-y-4 sm:space-y-5">
      ...
      {/* Attachments */}
      <div className="animate-pulse space-y-3 rounded-xl border border-zinc-200 bg-white/95 p-4 shadow-sm sm:p-6 dark:border-white/10 dark:bg-white/5">
