...
export function TopNav({ user, siteBookmarks, pendingRequestCount = 0 }: TopNavProps) {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-black/10 bg-white/90 backdrop-blur-md dark:border-white/10 dark:bg-zinc-900/90">
      <nav className="mx-auto w-full max-w-5xl px-3 py-2 sm:px-4 sm:py-3">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <span className="rounded-full bg-slate-100 px-2 py-1 text-xs font-medium text-black/70 sm:hidden dark:bg-zinc-800 dark:text-white/70">
              {user.role}
            </span>
        ...
        <div className="hide-scrollbar mt-2 flex items-center gap-2 overflow-x-auto pb-0.5">
          ...
          {overflowSiteBookmarks.length > 0 ? (
            <details className="relative">
              ...
              <div className="absolute right-0 z-50 mt-2 w-64 rounded-lg border border-slate-200 bg-white p-2 shadow-lg dark:border-zinc-700 dark:bg-zinc-900">
